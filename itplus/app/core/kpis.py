...
KPI_CATALOG: tuple[KpiDefinition, ...] = (
    ...
    KpiDefinition(
        ...
        name="Proyección de ingresos (próximo mes)",
        formula="Serie mensual de ingresos → promedio móvil 3m o tendencia lineal (se elige por menor MAPE de backtest)",
        unit="clp",
        aliases=(
            "proyecc",
            "predic",
        ...
        computable=True,
        notes="Horizonte 1 mes. Incluye banda de incertidumbre. No es ML avanzado.",
    ),
    KpiDefinition(
        key="margen_bruto",
        name="Margen bruto",
