...
const TABS = [
  { label: 'Inicio', path: '/', icon: <DashboardIcon fontSize="small" /> },
  { label: 'ITPlusBot', path: '/bot', icon: <SmartToyIcon fontSize="small" /> },
  { label: 'Consulta', path: '/consulta', icon: <SearchIcon fontSize="small" /> },
  { label: 'Documentos', path: '/documentos', icon: <FolderIcon fontSize="small" /> },
  { label: 'Historial', path: '/historial', icon: <HistoryIcon fontSize="small" /> },
]
